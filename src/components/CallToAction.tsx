    ...
    >
      ...
      <div className="-z-1 relative  mt-20 min-h-[100px]">
        <div className="absolute  left-0 right-0 top-20 z-10">
          ...
          <button className="font-geist z-10 text-md mx-auto mt-5 flex w-fit items-center justify-center gap-2 rounded-md bg-gradient-to-br from-indigo-400  to-indigo-700 px-10 py-2 text-center text-lg tracking-tighter text-zinc-50 ring-2 ring-indigo-500/50 ring-offset-2 ring-offset-zinc-950 transition-all hover:scale-[1.02] hover:ring-transparent active:scale-[0.98] active:ring-indigo-500/70">
            Explore more
          </button>
        </div>
        <div
