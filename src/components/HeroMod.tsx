...
const HeroMod = () => {
    return (
        ...
        <section className="relative max-w-full mx-auto  z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-10 gap-12 text-gray-600 md:px-8">
            <div className="space-y-5 max-w-3xl leading-0  lg:leading-5 mx-auto text-center">
              <h1 className="text-sm text-gray-200 group font-geist mx-auto px-5 py-2 bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit">
