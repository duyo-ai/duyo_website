    ...
    <div className="mb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {aiFeatures.map((feature, index) => (
                     <div key={feature.title} className="relative overflow-hidden rounded-2xl bg-slate-800/80">
...
function EditSection() {
  return (
    <div className="space-y-16">
      ...
      {/* 메인 피처 (드래그&드롭) - 큰 카드 */}
      <div className="relative overflow-hidden rounded-3xl bg-slate-800/80 p-8 lg:p-12">
