...
export default function RootLayout({
  ...
  return (
    ...
    >
      <div className="absolute top-0 z-[0] max-h-full w-screen bg-indigo-950/20  bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
      <BackgroundPlus />
